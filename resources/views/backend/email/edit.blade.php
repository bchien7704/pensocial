...
{!!  Form::open( array( 'route' => array('admin.email-account.update', $emailAccount->id), 'method' => 'PATCH', 'files'=>true)) !!}
...
<div class="control-group {!! $errors->has('port') ? 'has-error' : '' !!}">
    ...
    <div class="controls">
        {!! Form::text('port', $emailAccount->port ?: null, array('class'=>'form-control', 'id' => 'port', 'placeholder'=>'Port', 'value'=>Input::old('port'))) !!}
